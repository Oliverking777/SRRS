      ...
      <div style={styles.wrapper}>
        ...
        <div style={styles.statsGrid}>
          ...
          <div style={styles.statCard}>
            ...
            <div style={styles.statValue}>{userStats.total.toLocaleString()}</div>
          ...
          <div style={styles.statCard}>
            ...
            <div style={styles.statValue}>{userStats.active.toLocaleString()}</div>
            <div style={styles.statSubtext}>{Math.round((userStats.active / userStats.total) * 100)}% of total users</div>
          </div>
          
          {/* New Registrations */}
          <div style={styles.statCard}>
            <div style={styles.statLabel}>New Registrations</div>
            <div style={styles.statValue}>{userStats.newRegistrations.toLocaleString()}</div>
          ...
          <div style={styles.statCard}>
            ...
            <div style={styles.statValue}>{userStats.healthcare.toLocaleString()}</div>
            <div style={styles.statSubtext}>{Math.round((userStats.healthcare / userStats.total) * 100)}% of total users</div>
          </div>
        </div>
